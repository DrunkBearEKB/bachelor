...
from routes.common import BukinCommonRoutes
from routes.file_manager import BukinFileManagerRoutes
...
class Bukin(FlaskApplication):
    ...
    def _add_routes(self):
        routes_group = [BukinCommonRoutes, BukinFileManagerRoutes]
